...
export default function Clients() {
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      toast.error('Não foi possível excluir o cliente. Verifique se existem orçamentos vinculados.')
    } finally {
      setIsDeleting(false)
    }
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-slate-900">Clientes Cadastrados</h1>
        ...
        <AlertDialogContent className="max-w-md rounded-2xl bg-white animate-in zoom-in-95 duration-200">
          <AlertDialogHeader className="space-y-2">
            ...
            <AlertDialogDescription className="text-xs text-slate-500 leading-relaxed">
              ...
              <strong className="text-slate-800">&quot;{deleteTarget?.name}&quot;</strong>? Essa
              ação não pode ser desfeita. Todos os dados cadastrais serão removidos.
            </AlertDialogDescription>
          </AlertDialogHeader>
